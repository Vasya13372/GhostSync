...
function debug.setconstant(index, value)
    if constants[index] == nil then
...
-- Example usage
local success = debug.setconstant(2, "New Constant")
if success then
    print("Constant set successfully.")
else
    print("Failed to set constant; it already exists.")
end
